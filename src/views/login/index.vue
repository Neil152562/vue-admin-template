...
export default {
  ...
  data() {
    return {
      ...
      loginRules: {
        // 手机号必填，并进行格式效验
        mobile: [{ required: true, trigger: 'blur', message: '手机号必填' },
          { pattern: /^1[3-9]\d{9}$/, trigger: 'blur', message: '手机号不正确' }],
        // 密码必填，为6-16位数
        password: [{ required: true, trigger: 'blur', password: '密码必填' },
  ...
  methods: {
    ...
    /*  const res = await login(this.loginForm)
       console.log(res); */
      //  模块名store入口store.js去找
      // 方法名store/modules/user.js
  ...
  .el-input {
    ...
    input {
      ...
      &:-webkit-autofill {
          ...
          -webkit-text-fill-color: #68B0FE !important;
        }
    }
  }
